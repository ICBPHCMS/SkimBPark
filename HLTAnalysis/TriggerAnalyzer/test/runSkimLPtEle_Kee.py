...
"file:/vols/cms/vc1116/low_pt_electrons/step3_mc_Kee.root"
                            ),
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string( "outputBSkim_KeeVince_test_lowPtele.root" )
)
